module Applications
  class CreateApplication
    ...
    def call
      ...
      repository_connection = selected_repository_connection
    ...
    def app_params
      params.slice(:name, :description, :runtime_key, :repository_connection_id, :repository_url)
    end
    ...
    def selected_repository_connection
      ...
      matches = available_connections.select do |connection|
        app_params[:repository_url].to_s.start_with?(connection.endpoint_url)
      end
